#
#  Be sure to run `pod spec lint Mason.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Monsoir"
  # spec.authors            = { "Monsoir" => "raeyeung.mon@gmail.com" }
